...
\noindent\textbf{\dimiii}.	De acuerdo a \cite{grose_principios_2011}
...
\noindent\textbf{\dimdd}. Según \cite{canas_comunicacion_2019}
...
\begin{table}[ht!]
	...
	\begin{tabular}{cllcc}
		...
		\multirow{16}{*}{\rotatebox[origin=c]{90}{\makecell[{{p{3cm}}}]{\ce\variabled}}}
		                    ...
		                    &                                                   & \multirow{1}{*}{\fbbbbbbbbbbbbbbb} &                                                                              &                                                                \\\Xhline{1pt}
	\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabular}{cccc}
		...
		\midrule
		Tratamiento 1 (Clase 1) & O1  & X1          & w    \\
		Tratamiento 1 (Clase 1) & O2  & X2          &      \\
		Tratamiento 1 (Clase 1) & O3  & X3          &      \\
		\bottomrule
	\end{tabular}
\end{table}
