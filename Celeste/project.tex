...
\begin{table}[ht!]
	...
	\begin{tabular}{ccccccc}
		\Xhline{1pt}
		\textbf{{VD}} & \textbf{{D}}                                      & \textbf{Indicadores}             & \textbf{Items}                                                               & \textbf{Escala}                                                             & \textbf{Valores} \\\hline
		\multirow{14}{*}{\rotatebox[origin=c]{90}{\makecell[{{p{5cm}}}]{\centering\variablei}}}
		              & \multirow{3}{*}{\makecell[{{p{3cm}}}]{\ce\dimi}}  & \multirow{1}{*}{\gb}             & \multirow{14}{*}{\rotatebox[origin=c]{90}{\makecell{Cuantitativa continua}}} & \multirow{14}{*}{\rotatebox[origin=c]{90}{\makecell{Valoración cuantitaitva                    \\0 a 20}}} \\\cline{3-4}
...
\begin{table}[ht!]
	...
	\begin{tabular}{cllcc}
		...
		\multirow{16}{*}{\rotatebox[origin=c]{90}{\makecell[{{p{3cm}}}]{\ce\variabled}}}
		                    & \multirow{4}{*}{\makecell[{{p{2.5cm}}}]{\dimd}}   & \multirow{1}{*}{\fb}               & \multirow{16}{*}{\rotatebox[origin=c]{90}{\makecell{Cuantitativa continua}}} & \multirow{16}{*}{\rotatebox[origin=c]{90}{\makecell{Valoración \\cuantitaitva de 0 a 20}}}\\\cline{3-4}
		                    ...
		                    &                                                   & \multirow{1}{*}{\fbbbbbbbbbbb}     &                                                                              &                                                                \\\cline{3-3}
...
\begin{table}
	\caption{wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww}
	\label{key}
...
Constituida por \poblacion, matriculados en el 2023. %Los criterios que se considerarán en la selección de la muestra se describen en el Cuadro \ref{apt7}
	...
	\begin{table}[ht!]\caption{Matriz de instrumentos de la variable \MakeTextLowercase{\variabled}}
		...
		\begin{tabular}{cccccc} 			\hline\ce\bf VARIABLE                          & \ce\bf DIMENSIONES & \ce\bf INDICADORES & \ce\bf ÍTEMS                                        & \ce\bf VALORACIÓN & \bf INSTRUMENTOS \Tstrut \\
			...
			\multirow{20}{*}{\rotatebox[origin=c]{90}{Ficha de observación}}                                                                                                                                       \\\cline{4-4}
			                                                        &                    &                    &
			P2: ¿Plasma degradación entre los colores?              &                                                                                                                                              \\\cline{3-4} 			&&	\multirow{2}{*}{\fbb}                                   &		P3: ¿Utiliza formas y superficies regulares?                                                                                                                                                           \\\cline{4-4}
			                                                        &                    &                    &
			P4: ¿Utiliza formas irregulares someramente?            &                                                                                                                                              \\\cline{3-4} 	&&			\multirow{1}{*}{\fbbb}                                  &
			P5: ¿Manifiesta degradación de texturas?                                                                                                                                                               \\\cline{2-4} 			&
			\multirow{5}{*}{\dimdd}                                 &
			\multirow{2}{*}{\fbbbb}                                 &
			P6: ¿Distribuye adecuadamente los tonos?                                                                                                                                                               \\\cline{4-4}
			                                                        &                    &                    &
			P7: ¿Asocia adecuadamente los tonos?                    &                                                                                                                                              \\\cline{3-4} 			&&			\multirow{1}{*}{\fbbbbb}                                &
			P8: ¿Asocia proporcionalmente los volúmenes?                                                                                                                                                           \\\cline{3-4} 		&&			\multirow{2}{*}{\fbbbbbb}                               &
			...
			P11: ¿Representa elementos con dimensión creciente?                                                                                                                                                    \\ \cline{4-4}
			                                                        &                    &                    &
			P12: ¿Manifiesta elementos plásticos proporcionalmente? &                                                                                                                                              \\\cline{3-4}&&			\multirow{1}{*}{\fbbbbbbbb}                             &
			P13: ¿Representa los elementos plásticos de manera decreciente?                                                                                                                                        \\\cline{3-4}&&			\multirow{2}{*}{\fbbbbbbbb}                             &
			P14: ¿Conjuga los elementos plásticos?                                                                                                                                                                 \\\cline{4-4}
			                                                        &                    &                    & p15: ¿Distribuye elementos, constantes ligeramente? &                                              \\\cline{3-4} 			&&			\multirow{2}{*}{\fbbbbbbbbb}                            &
