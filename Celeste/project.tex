...
\begin{table}[ht!]
	...
	\label{www}\begin{tabular}{ccccccc}
		\Xhline{1pt} 		\textbf{{VD}} & \textbf{{D}}                                      & \textbf{Indicadores}            & \textbf{Items}                                                   & \textbf{Escala} & \textbf{Valores} \\ 		\hline 		\multirow{14}{*}{\rotatebox[origin=c]{90}
...
\begin{table}[ht!]
	...
	\label{wwwww}
	\begin{tabular}{cccccc} 		\Xhline{1pt} 		\textbf{{VD}} & \textbf{{D}}                                         & \textbf{Indicadores}         & \textbf{Items}                                                              & \textbf{Escala}                                               & \textbf{Valores} \\ 		\hline 		\multirow{9}{*}{\rotatebox[origin=c]{90}{\makecell[{{p{3.9cm}}}]{\ce\variabled}}}
