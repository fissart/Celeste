...
\newglossaryentry{imaginacion}{name=Imaginación,description={La imaginación es la capacidad que tiene la mente de crear imágenes y experiencias que no existen en la realidad. Es algo que nos permite soñar, inventar y crear nuevas ideas y conceptos. A través de la imaginación, podemos explorar diferentes escenarios y posibilidades, y así expandir nuestra forma de pensar. Es una herramienta fundamental para el arte, la literatura y la creatividad en general.}}

\newglossaryentry{fantasia}{name=Fantasía,description={La fantasía es un género literario y cinematográfico que se caracteriza por presentar mundos imaginarios, personajes extraordinarios y situaciones irreales. En literatura, la fantasía se encuentra ampliamente representada por obras como "El Señor de los Anillos" de J.R.R. Tolkien o "Harry Potter" de J.K. Rowling. Estas historias suelen involucrar elementos como magia, criaturas fantásticas, batallas épicas, viajes a otros mundos, entre otros.}}
